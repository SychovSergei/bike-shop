...
export class CreateProductPageComponent implements OnInit {
  ...
  submit() {
    ...
    this.product = {
      ...
      shipping: this.productForm.controls['shipping'].value.name,
      shop: this.productForm.controls['shop'].value.name,
      color: this.getFieldsName(this.productForm.controls['color'].value),
      size: this.getFieldsName(this.productForm.controls['size'].value),
